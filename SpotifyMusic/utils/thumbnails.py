...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("SpotifyMusic/assets/assets/font2.ttf", 30)
    font = ImageFont.truetype("SpotifyMusic/assets/assets/font.ttf", 30)
    title_font = ImageFont.truetype("SpotifyMusic/assets/assets/font3.ttf", 45)
    ...
    play_icons = Image.open("SpotifyMusic/assets/assets/play_icons.png")
